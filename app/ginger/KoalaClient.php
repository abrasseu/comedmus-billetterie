...
class KoalaClient {
  ...
  protected function apiCall($endpoint, $params = array(), $method = "GET") {
    ...
    if (curl_errno($ch) != 0) {
      throw new ApiException(503, self::$error_codes[curl_errno($ch)]);
    }
    ...
    // Sinon, on renvoie les infos
      ...
      return json_decode($result, true); // Retourner un array avec true, false pour un StdClass
    }
  }
}
